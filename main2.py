...
def extract_features_for_song(song_path):
    ...
    energy = float(np.sum(y ** 2) / len(y))  # Ensure energy is a scalar
    ...
    # Construct the 10-feature set with scalar values
    features = [
        tempo, energy, spectral_centroid, zcr, spectral_contrast,  # 5 features for arousal
